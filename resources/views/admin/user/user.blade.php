                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif($user->role === 'Petugas')
                                            <span class="badge bg-success me-1">Petugas</span>
                                        @elseif($user->role === 'Koordinator')
                                            <span class="badge bg-danger me-1">Koordinator</span>
                                        @elseif($user->role === 'Supervisor')
                                            <span class="badge bg-warning me-1">Supervisor</span>
                                        @elseif($user->role === 'Owner')
                                            <span class="badge bg-info me-1">Owner</span>
                                        @else
                                        @endif
                                    </td>
                                    <td>
