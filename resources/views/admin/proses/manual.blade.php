            ...
            <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 px-0 me-sm-6">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Manual Input</li>
                    </ol>
                </div>
            </div>
            <!-- /Search -->
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Input Manual Data</h4>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ url('/proses/send') }}">
                            @csrf
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">Truck
                                    Information</label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-icon-default-company">Empty Weight</label>
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-icon-default-company">Max Weight</label>
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        <span id="beban_kosong" class="input-group-text">kg</span>
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 form-label" for="basic-icon-default-phone">Payload Type</label>
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
