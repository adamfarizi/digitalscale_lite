            ...
            <div class="card-header pb-0">
                <div class="row">
                    <div class="col d-flex">
                        <h4 class="card-title">Table Verification</h4>
                    </div>
                            ...
                            @else
                                @foreach ($truck as $key => $truck)
                                    <tr>
                                        ...
                                        <td class="p-0">
                                            <form method="POST" action="{{ url('/verification/' . $truck->muatan->id_muatan) }}">
                                                @csrf
                                                <button type="submit" class="btn btn-sm btn-primary">
                                                    <span class="tf-icons bx bx-user-check me-1"></span> Verif
                                                </button>
                                            </form>
                                        </td>
                                    </tr>
